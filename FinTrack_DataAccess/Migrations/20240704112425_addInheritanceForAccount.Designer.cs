...
namespace FinTrack_DataAccess.Migrations
{
    ...
    [Migration("20240704112425_addInheritanceForAccount")]
    partial class addInheritanceForAccount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinTrack_DataAccess.MarketData", b =>
                {
                    b.Property<string>("Symbol")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("FinTrack_DataAccess.Account", b =>
                {
                    b.HasOne("FinTrack_DataAccess.ApplicationUser", "User")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("FinTrack_DataAccess.Budget", b =>
                {
                    ...
                    b.HasOne("FinTrack_DataAccess.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
